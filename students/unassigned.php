...
if(isset($_REQUEST['active']))
{
  ...
  if($ex)
  {
    ...
    header("location:".BASE_URL."admin/students/unassigned.php?update=".$delete);
  }
  else
  {
    $error="Not Activated";
    header("location:".BASE_URL."admin/students/unassigned.php?error=".$error);
  }
}
...
if(isset($_REQUEST['delete']))
{
  ...
  if($dex)
  {
    ...
    header("location:".BASE_URL."admin/students/unassigned.php?deletemsg=".$delete);
  }
  else
  {
    $error="Not Deleted";
    header("location:".BASE_URL."admin/students/unassigned.php?deletemsg=".$error);
  }
}
?>
<!DOCTYPE html>
          ...
          <div class="box">
            ...
            <div class="box-body table-responsive">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php
                $sql="SELECT * FROM `student` join `class` on `student`.class=class.classid WHERE student.school=".$_SESSION['schooladmin']['id']." AND parent='0'";
                $ex=$conn->query($sql);
                $i=1;
