...
if(isset($_POST['Add']))
{
  ...
  if($type=='all')
  {
    ...
    if($ex)
    {
        ...
        $ex1 = $conn->query($sql1);
         $registration_ids = [];
         $sql1 = "SELECT * FROM `schoolannouncements` WHERE id='$announcement'";
      $result1 = $conn->query($sql1);
      $total1 = $result1->num_rows;
        $stud = "SELECT parent FROM `student` WHERE school='$school' GROUP BY parent";
       ...
       $msg['data']['message'] = "You have New Announcement";
    ...
    if($ex)
    {
     ...
     if($ex1){
      ...
      $total1 = $result1->num_rows;
          ...
          $i = 0;
          $j = 0;
      for($b=0;$b<count($_POST['class']);$b++)
      {
    
            
        $classs = $_POST['class'][$b];
        $stud = "SELECT parent FROM `student` WHERE class='$classs' AND school='$school' GROUP BY parent";
          $studresult = $conn->query($stud);
       ...
       $msg = array('hi');
       $msg['data']['msg'] = "newhomework";
       $msg['data']['message'] = "You have Announcement";
       $msg['data']['image'] = $data['document'];
       $msg['data']['channel'] = "newhomework";
          ...
          <div class="box box-primary">
            ...
            <form role="form" method="post">
              ...
              <div class="box-footer">
                ...
                <a href="<?php echo BASE_URL ?>admin/announcement/listannouncement.php" class="btn btn-primary">List</a>
              </div>
            </form>
          </div>
          <!-- /.box -->
